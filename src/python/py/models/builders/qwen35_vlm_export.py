            ...
            "provider_options": [
                {
                    "NvTensorRtRtx": {
                        "enable_cuda_graph": "0",
                        "nv_profile_min_shapes": "pixel_values:768x1536,image_grid_thw:1x3",
                        "nv_profile_opt_shapes": "pixel_values:768x1536,image_grid_thw:1x3",
                        "nv_profile_max_shapes": "pixel_values:768x1536,image_grid_thw:1x3",
                    }
                }
            ],
        }
...
def export_qwen35_vlm_components(
    ...
    vision = Qwen35VisionModel(config.vision_config)
    ...
    pixel_values = torch.randn((768, 3 * config.vision_config.temporal_patch_size * config.vision_config.patch_size**2), dtype=dtype)
    image_grid_thw = torch.tensor([[1, 24, 32]], dtype=torch.int64)
    _export_onnx(
        vision,
        ...
        ["pixel_values", "image_grid_thw"],
        ["image_features"],
        dynamic_shapes={"pixel_values": {0: torch.export.Dim("num_patches")}, "image_grid_thw": None},
    )
