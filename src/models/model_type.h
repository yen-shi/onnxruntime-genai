...
struct ModelType {
  inline static bool IsLLM(const std::string& model_type) {
    ...
    static constexpr std::array<std::string_view, 26> LLM = {"chatglm", "decoder", "ernie4_5", "gemma", "gemma2", "gemma3_text", "gemma4_text", "gpt2", "gptoss", "granite", "hunyuandensev1", "internlm2", "lfm2", "llama", "mistral", "nemotron", "olmo", "phi", "phimoe", "phi3", "phi3small", "qwen2", "qwen3", "qwen3_5_text", "qwen3_5_moe_text", "smollm3"};
  ...
  inline static bool IsQwenVLFamily(const std::string& model_type) {
    ...
    static constexpr std::array<std::string_view, 4> QwenVL = {"fara", "qwen2_5_vl", "qwen3_vl", "qwen3_5"};
